...
BEGIN
  ...
  ON CONFLICT (sku, pricing_date) DO NOTHING;

  RAISE NOTICE 'EL 500 ml | 2026-03-10 | ppb=4.9048 gst=5%% | bpc=%', v_bpc_el500;
  ...
  RAISE NOTICE 'P 250 ml  | 2026-03-10 | ppb=3.6   gst=5%% | bpc=%', v_bpc_p250;
