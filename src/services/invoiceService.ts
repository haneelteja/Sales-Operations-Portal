...
export function prepareInvoiceData(
  ...
  return {
    ...
    dealerName: transaction.customers?.dealer_name || customer.dealer_name,
    area: transaction.branch || transaction.customers?.area || customer.area,
...
export function prepareMultiInvoiceData(
  ...
  return {
    ...
    companyEmail: companyConfig.email,
    companyGSTIN: companyConfig.gstin,
    dealerName: transactions[0].customers?.dealer_name || customer.dealer_name,
    area: transactions[0].branch || transactions[0].customers?.area || customer.area,
    clientAddress: undefined,
    clientPhone: undefined,
    clientEmail: undefined,
    items,
